...
class Graph():
    def __init__(self,label=None,density=3,storage=primitive_store):
        ...
        #self.__hasher__ = lambda v :  hashlib.md5(str(v) ).hexdigest()[:density]
    ...
    def add_edge(self,a,b):
        a_hash = self.__properties_hasher__(a) #self.__hasher__(a)
        b_hash = self.__properties_hasher__(b) #self.__hasher__(b)
#        self.__properties__[a_hash] =a 
#        self.__properties__[b_hash] =b
    ...
    def edge_mapper(g1, fn):
        for a,b in g1.__edges__:
            #v_a  = g1.__properties__[a] 
            #v_b  = g1.__properties__[b] 
    ...
    def group(g,group_lambdas,start=None):
        ...
        while True:
            ...
            if len(unvisited) > 0:
                ...
                #print "univisited=",len(unvisited),", start=",start
